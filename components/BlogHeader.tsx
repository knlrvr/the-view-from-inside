      ...
      return (
        <header className="h-screen grid grid-cols-1">
          ...
          <div className="flex justify-between items-end pb-6 md:pb-0">
            ...
            <Reveal>
              <div className="w-24 h-24 md:w-36 md:h-36 lg:w-48 lg:h-48 mx-2 pt-6 fill-teal-800">
                <svg xmlns="http://www.w3.org/2000/svg" version="1.0" preserveAspectRatio="xMidYMid meet" viewBox="107 209 271 145.4">
