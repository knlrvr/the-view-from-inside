      ...
      return (
        <header className="">
          <div className="h-screen py-8 grid grid-cols-1">
            <div className="w-1/2">
              <Reveal>
                <h1 className="text-8xl md:text-9xl lg:text-[10rem] font-bold leading-tight tracking-tight">the view from inside.</h1>
              </Reveal>
            </div>
            <div className="flex justify-between items-end">
              <Link href="/#heropost" className="flex flex-col pb-4">
                <span className="-rotate-90 pb-10 pl-6 text-neutral-300 text-sm">explore</span>
                <HiOutlineArrowLongDown 
                  className="text-4xl text-[#222] animate-bounce" />
              </Link>
              <Reveal>
                <div className="w-24 h-24 md:w-36 md:h-36 lg:w-48 lg:h-48">
